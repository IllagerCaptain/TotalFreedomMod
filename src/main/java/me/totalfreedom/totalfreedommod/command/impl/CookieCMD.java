...
@CommandParameters(name = "cookie", description = "For those who have no friends - gives a cookie to everyone on the server.", usage = "/<command>")
public class CookieCMD extends FreedomCommand {
