...
@CommandParameters(name = "scare", description = "Sends a guardian particle effect with an enderman scream to the specified player.", usage = "/<command> <player>")
public class ScareCMD extends FreedomCommand {
    @Override
