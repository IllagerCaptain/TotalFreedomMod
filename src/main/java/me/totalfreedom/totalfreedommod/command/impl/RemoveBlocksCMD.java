...
@CommandParameters(name = "ro", description = "Remove all blocks of a certain type in the radius of certain players.", usage = "/<command> <block> [radius (default=50)] [player]")
public class RemoveBlocksCMD extends FreedomCommand {
