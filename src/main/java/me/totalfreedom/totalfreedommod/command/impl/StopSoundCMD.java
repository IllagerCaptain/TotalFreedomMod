...
@CommandParameters(name = "stopsound", description = "Stops all sounds or a specified sound.", usage = "/<command> [sound]")
public class StopSoundCMD extends FreedomCommand {
