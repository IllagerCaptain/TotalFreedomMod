...
@CommandParameters(name = "purgeall", description = "Purge current mutes, command blocks, orbits, freezes, potion effects, cages, and entities.", usage = "/<command>")
public class PurgeallCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        plugin.freezer.setGlobalFreeze(false);

        // Remove all mobs
        plugin.entityWiper.purgeMobs(null);
