        ...
        switch (args.length) {
            ...
            case 2: {
                if (args[0].equalsIgnoreCase("clear")) {
                    ...
                    if (args.length == 2) {
                        if (!plugin.adminList.isAdmin(sender) && !args[1].equalsIgnoreCase(sender.getName())) {
            ...
            case 5: {
                if (args[0].equalsIgnoreCase("add")) {
                    ...
                    if (args.length == 5) {
                        if (!plugin.adminList.isAdmin(sender) && !args[4].equalsIgnoreCase(sender.getName())) {
                        ...
                        if (target == null || plugin.adminList.isVanished(target.getName()) && !plugin.adminList.isAdmin(sender)) {
