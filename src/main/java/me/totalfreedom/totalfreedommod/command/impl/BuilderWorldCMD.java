...
@CommandParameters(name = "masterbuilderworld", description = "Allows for master builders to configure the time, the weather of the MasterBuilder, and allows for players to go to the MasterBuilderWorld.",
        usage = "/<command> [time <morning | noon | evening | night> | weather <off | rain | storm>]",
        aliases = "mbw,mbworld,builderworld")
public class BuilderWorldCMD extends FreedomCommand {
        ...
        try {
            switch (commandMode) {
                case TELEPORT: {
                    ...
                    try {
                        masterBuilderWorld = plugin.worldManager.masterBuilderWorld.getWorld();
                ...
                case TIME: {
                    ...
                    if (args.length == 2) {
                        ...
                        if (timeOfDay != null) {
                            plugin.worldManager.masterBuilderWorld.setTimeOfDay(timeOfDay);
                ...
                case WEATHER: {
                    ...
                    if (args.length == 2) {
                        ...
                        if (weatherMode != null) {
                            plugin.worldManager.masterBuilderWorld.setWeatherMode(weatherMode);
    ...
    private void assertCommandPerms(CommandSender sender, Player playerSender) throws PermissionDeniedException {
        if (!(sender instanceof Player) || playerSender == null || !plugin.adminList.isAdmin(playerSender)) {
