...
@CommandParameters(name = "tagnyan", description = "Give yourself a prefix with random colors", usage = "/<command> <tag>", aliases = "tn")
public class TagNyanCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        final FPlayer data = plugin.playerList.getPlayer(playerSender);
        data.setTag(tagStr);
