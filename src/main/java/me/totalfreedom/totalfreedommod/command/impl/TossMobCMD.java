...
@CommandParameters(name = "tossmob", description = "Throw a mob in the direction you are facing when you right click with a bone.",
        usage = "/<command> <mobtype [speed] | off | list>")
public class TossMobCMD extends FreedomCommand {
