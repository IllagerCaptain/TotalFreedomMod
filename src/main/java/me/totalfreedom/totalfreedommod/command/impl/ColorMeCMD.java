...
@CommandParameters(name = "colorme", description = "Essentials Interface Command - Set your nickname to a certain color.", usage = "/<command> <color>")
public class ColorMeCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        if (plugin.essentialsBridge.isEnabled())
                plugin.essentialsBridge.setNickname(sender.getName(), newNick);
        else ((Player)sender).setDisplayName(newNick);
