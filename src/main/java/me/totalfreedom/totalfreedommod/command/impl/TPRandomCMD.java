...
@CommandParameters(name = "tprandom", description = "Go to a random location in the current world you are in", usage = "/<command>", aliases = "tpr,rtp")
public class TPRandomCMD extends FreedomCommand {
    @Override
