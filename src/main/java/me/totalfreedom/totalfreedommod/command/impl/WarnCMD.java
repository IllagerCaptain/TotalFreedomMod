...
@CommandParameters(name = "warn", description = "Warns the specified player.", usage = "/<command> [-q] <player> <reason>")
public class WarnCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        plugin.playerList.getPlayer(player).incrementWarnings(quiet);
        plugin.punishmentList.logPunishment(new Punishment(player.getName(), FUtil.getIp(player), sender.getName(), PunishmentType.WARN, warnReason));
        ...
        if (quiet) {
            ...
            String adminNotice = ChatColor.RED +
                    ...
                    ChatColor.YELLOW +
                    warnReason;
            plugin.adminList.messageAllAdmins(adminNotice);
