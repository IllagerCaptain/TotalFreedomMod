...
@CommandParameters(name = "g", description = "Send a command as someone else.", usage = "/<command> <fromname> <outcommand>")
public class GcmdCMD extends FreedomCommand {
    @Override
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        if (plugin.commandBlocker.isCommandBlocked(outCommand, sender)) {
            return true;
        }
