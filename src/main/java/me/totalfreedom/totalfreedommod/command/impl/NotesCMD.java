...
@CommandParameters(name = "notes", description = "Manage notes for a player", usage = "/<command> <name> <list | add <note> | remove <id> | clear>")
public class NotesCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        if (player == null) {
            ...
            playerData = plugin.playerList.getData(entry.getName());
        } else {
            playerData = plugin.playerList.getData(player);
        }
