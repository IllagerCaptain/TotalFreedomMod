...
import me.totalfreedom.totalfreedommod.services.impl.GameRuleHandler;
import me.totalfreedom.totalfreedommod.services.impl.LoginProcess;
...
@CommandParameters(name = "toggle", description = "Toggles TotalFreedomMod settings", usage = "/<command> [option] [value] [value]")
public class ToggleCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "firespread": {
                ...
                plugin.gameRuleHandler.setGameRule(GameRuleHandler.GameRule.DO_FIRE_TICK, ConfigEntry.ALLOW_FIRE_SPREAD.getBoolean());
                break;
            }
