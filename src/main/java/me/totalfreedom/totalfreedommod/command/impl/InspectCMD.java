...
@CommandParameters(name = "inspect", description = "Block inspector tool for operators", usage = "/<command> [history] <page>", aliases = "ins")
public class InspectCMD extends FreedomCommand {
