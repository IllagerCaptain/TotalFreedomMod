...
@CommandParameters(name = "setlever", description = "Set the on/off state of the lever at position x, y, z in world 'worldname'.", usage = "/<command> <x> <y> <z> <worldname> <on|off>")
public class SetLeverCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        if (targetBlock.getType() == Material.LEVER) {
            ...
            plugin.coreProtectBridge.getCoreProtectAPI().logInteraction(sender.getName(), leverLocation);
        } else {
