...
@CommandParameters(name = "plugincontrol", description = "Enable, disable, or reload a specified plugin, as well as list all plugins on the server.", usage = "/<command> <<enable | disable | reload> <pluginname>> | list>", aliases = "plc")
public class PluginControlCMD extends FreedomCommand {
