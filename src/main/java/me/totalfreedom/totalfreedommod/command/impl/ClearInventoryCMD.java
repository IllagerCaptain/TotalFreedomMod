...
@CommandParameters(name = "clearinventory", description = "Clear your inventory.", usage = "/<command> [player]", aliases = "ci,clear")
public class ClearInventoryCMD extends FreedomCommand {
