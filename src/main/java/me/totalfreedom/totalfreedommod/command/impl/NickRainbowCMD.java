...
@CommandParameters(name = "nickrainbow", description = "Essentials Interface Command - Rainbowify your nickname.", usage = "/<command> <nick>")
public class NickRainbowCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        if (plugin.essentialsBridge.isEnabled())
            ...
            ((Player)sender).setDisplayName(newNick);
        }
