...
@CommandParameters(name = "nickgradient", description = "Essentials Interface Command - Rainbowify your nickname.", usage = "/<command> <hex> <hex> <nick>", aliases = "nickgr")
public class NickGradientCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        if (plugin.essentialsBridge.isEnabled())
            plugin.essentialsBridge.setNickname(sender.getName(), outputNick);
        else {
            ((Player)sender).setDisplayName(outputNick);
        }
