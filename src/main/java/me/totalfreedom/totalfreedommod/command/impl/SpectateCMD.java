...
@CommandParameters(name = "spectate", description = "Quickly spectate someone.", usage = "/<command> <playername>", aliases = "spec")
public class SpectateCMD extends FreedomCommand {
