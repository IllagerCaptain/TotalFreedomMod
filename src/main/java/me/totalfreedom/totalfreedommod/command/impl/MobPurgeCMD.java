...
@CommandParameters(name = "mobpurge", description = "Purge all mobs in all worlds.", usage = "/<command> [name]", aliases = "mp")
public class MobPurgeCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        int count = plugin.entityWiper.purgeMobs(type);
