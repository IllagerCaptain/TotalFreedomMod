...
@CommandParameters(name = "lockup", description = "This is evil, and I never should have wrote it - blocks specified player's input.", usage = "/<command> <all | purge | <<partialname> on | off> [-q]>")
public class LockupCMD extends FreedomCommand {
    ...
    private void cancelLockup(final Player player) {
        cancelLockup(plugin.playerList.getPlayer(player));
    }
