...
@CommandParameters(name = "playerverification", description = "Manage your verification", usage = "/<command> <enable | disable | clearips | clearip <ip> | status | genbackupcodes>", aliases = "playerverify,pv")
public class PlayerVerificationCMD extends FreedomCommand {
    @Override
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        PlayerData target = plugin.playerList.getData(playerSender);
        ...
        if (verificationEnabled) {
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "genbackupcodes": {
                    ...
                    boolean generated = plugin.discord.sendBackupCodes(data);
