...
@CommandParameters(name = "coins", description = "Shows the amount of coins you or another player has. Also allows you to give coins to other players.", usage = "/<command> [player] | pay <player> <amount>")
public class CoinsCMD extends FreedomCommand {
    @Override
