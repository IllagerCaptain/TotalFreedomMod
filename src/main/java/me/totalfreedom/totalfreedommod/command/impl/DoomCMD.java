...
@CommandParameters(name = "doom", description = "Sends the specified player to their doom.", usage = "/<command> <playername> [reason]")
public class DoomCMD extends FreedomCommand {
    ...
    public boolean run(final CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        // Log doom
        plugin.punishmentList.logPunishment(new Punishment(player.getName(), FUtil.getIp(player), sender.getName(), PunishmentType.DOOM, reason));
