...
@CommandParameters(name = "potionspy", description = "Allows admins to see potions that are thrown.", usage = "/<command> <enable | on | disable | off> | history [player] <page>", aliases = "potspy")
public class PotionSpyCMD extends FreedomCommand {
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "history":
                    if (args.length == 3) {
                        ...
                        List<Map.Entry<ThrownPotion, Long>> thrownPotions = new ArrayList<>(plugin.monitors.getPlayerThrownPotions(player)); // Make a copy of the list to avoid modifying the original.
                        ...
                        for (Map.Entry<ThrownPotion, Long> potionEntry : thrownPotions) {
                            ...
                            boolean trollPotions = plugin.monitors.isTrollPotion(potion);
                        ...
                        thrownPotions.addAll(plugin.monitors.getAllThrownPotions()); // Make a copy of the list to avoid modifying the original.
