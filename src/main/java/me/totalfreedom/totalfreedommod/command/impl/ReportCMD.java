...
@CommandParameters(name = "report", description = "Report a player for all admins to see.", usage = "/<command> <player> <reason>")
public class ReportCMD extends FreedomCommand {
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        ...
        if (plugin.discord.enabled) {
            logged = plugin.discord.sendReport(playerSender, player, report);
        }
