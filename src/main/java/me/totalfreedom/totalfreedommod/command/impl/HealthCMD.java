...
@CommandParameters(name = "health", description = "View server health, such as ticks-per-second, memory, etc.", usage = "/<command>")
public class HealthCMD extends FreedomCommand {
