package me.totalfreedom.totalfreedommod.player.permissions;
...
public class PermissionManager extends AbstractService
{
    ...
    public void setPermissions(Player player)
    {
        ...
        List<String> nodes = permissions.get(plugin.rankManager.getRank(player));
        if (nodes != null)
        {
