package me.totalfreedom.totalfreedommod.punishments.caging;
...
public class Cager extends AbstractService
{
    ...
    public void onBreakBlock(BlockBreakEvent event)
    {
        ...
        FPlayer fPlayer = plugin.playerList.getPlayer(event.getPlayer());
    ...
    {
        FPlayer player = plugin.playerList.getPlayer(event.getPlayer());
