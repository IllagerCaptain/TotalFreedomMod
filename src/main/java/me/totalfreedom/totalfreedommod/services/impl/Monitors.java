...
public class Monitors extends AbstractService
{
    ...
    public void onStart()
    {
        Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, () ->
        {
            for (Player player : recentlyThrownPotions.keySet())
            {
                ...
                plugin.adminList.potionSpyMessage(ChatColor.translateAlternateColorCodes('&', String.format("&8[&ePotionSpy&8] &r%s splashed %s %s at X: %s Y: %s Z: %s in the world '%s'%s.",
